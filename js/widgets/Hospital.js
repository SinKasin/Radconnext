...
function RadHospital(UserID) {
            ...
            success: function(data) {
              if(data.Response == 'success'){
                var vHos_ID = data.data[0].Hos_ID;
                var vHos_Name = data.data[0].Hos_Name;
                var vHos_OrthancID = data.data[0].Hos_OrthancID;
                var vHos_Address = data.data[0].Hos_Address;
                var vHos_OrthancID = data.data[0].Hos_OrthancID;
                var vHos_Tel_1 = data.data[0].Hos_Tel_1;
                var vHos_Contact = data.data[0].Hos_Contact;
                var vHos_Remark = data.data[0].Hos_Remark;
...
function UPD_RadHospital(vUserID) {
