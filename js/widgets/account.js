$(document).ready(function () {
  ...
  $("#gridCaseActive").jqxGrid(
            ...
            $("#print").click(function () {
                var gridContent = $("#gridCaseActive").jqxGrid('exportdata', 'html');
            ...
            $("#UpdateAMT").on('click', function () {
                var CaseID = $("#vCaseID").val();
                SRAD_UPDATE_CASE_AMT(CaseID);
            });
...
function SRAD_UPDATE_CASE_AMT(CaseID) {

            let Order_Price = $('#vCaseAMT').val();
            let Order_DF = $('#vCaseDFAMT').val();
            var act = 'SRAD_UPDATE_CASE_AMT';
            var url = "sapi/api.class.php?action="+ act
            var pData = {
                CaseID : CaseID,
                CaseAMT : Order_Price,
